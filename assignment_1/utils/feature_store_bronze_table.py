...
def feature_store_bronze_table(snapshot_date_str, bronze_feature_store_directory, spark):
    # prepare arguments
    ...
    df = features_df.join(financial_df, on=['Customer_ID', 'snapshot_date'], how='outer')
