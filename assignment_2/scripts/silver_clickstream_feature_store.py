...
import utils.data_feature_silver_table
...
def main(snapshotdate):
    ...
    # run data processing
    utils.data_feature_silver_table.process_silver_clickstream_table(date_str, bronze_clks_directory, silver_clks_directory, spark)
